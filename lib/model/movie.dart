...
final String duration;
  ...
  Movie({required this.id, required this.title, required this.imageUrl, required this.description, required this.rating, required this.year, required this.duration});
}
final movieList = [
  Movie(
    id: 'tt4154796',
